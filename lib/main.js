    ...
    .then(events => {
        ...
        .then(uri => {
            mongodb.MongoClient.connect(uri, function(err, db){
                if (err) throw err;
                clog('LOG:\tConnection to mlab opened')
                let colArr = [];
                ...
                for (var i = 0; i < events.length; i++){
                    ...
                    // --
                    // Push collections to colArr
                    // Log reduced array on db close
                    // --
                ...
                db.close(function (err) {
                    ...
                    clog('LOG:\tConnection to mlab closed')
                });
            })
        })
    }
